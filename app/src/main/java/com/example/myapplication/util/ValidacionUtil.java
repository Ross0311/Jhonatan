...
public class ValidacionUtil {
    ...
    public static final String ANIO = "[2][0][0-9]{2}";
    public static final String SERIE = "[0-9]{8}";
    public static final String ESTADO = "[0-1]";
    public static final String FECHAA = "((19|20)\\d\\d)-(0?[1-9]|1[012])-(0?[1-9]|[12][0-9]|3[01])";
